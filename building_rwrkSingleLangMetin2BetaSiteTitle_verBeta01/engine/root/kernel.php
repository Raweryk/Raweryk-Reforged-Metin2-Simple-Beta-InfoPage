...
<html lang="pl">
	...
	<body <?php if ($debugMode == 1) { echo "style='margin: 3% 0% !important'"; } ?>>
		<?php if(isset($_GET['rwrk'])) { echo "tak" ; } else { echo "nie" ; }?>
		...
		<span id='rwrkError_Link'><a href='/index.html'>Naciśnij tutaj, aby powrócić</a> <span id='rwrkError_Blink'>_</span></span>
		"; }
